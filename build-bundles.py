...
BUNDLES = [
    ...
    },
    {
        ...
        'emoji': '📏',
        'sub': '网格标准与成图样例 + 分享模板总目录（23+4）。源文件：规范-网格标准与成图样例 · 规范-分享模板总目录',
        'parts': [
    ...
    },
    {
        ...
        'title': 'ATOM 分享模块 · 原子库',
        'emoji': '📐',
        'sub': '全原子低保真线框总板 + 原子规格 + 报告与洞察深钻。源文件：原子-低保真线框总板 · 原子-*规格 · 深钻-*',
        'parts': [
            ('01 · 低保真线框总板（24+7 原子）', '原子-低保真线框总板.html'),
            ('02 · 原子规格 · B2 肌肉热力图', '原子-B2肌肉热力图规格.html'),
            ('03 · 深钻 · 课后报告与洞察设计 ★', '深钻-课后报告与洞察设计.html'),
        ],
    },
]
